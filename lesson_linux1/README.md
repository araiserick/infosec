...
Устанавливаем hashcat, но вместо данной утилиты будем использовать утилиту john
...
сохраняем hash в файлик

```
echo '$6$LXtFFs9lpTMP9OB8$Pt8bV28JD2GWQ3vHUa9cLiAOv/KLUrLBPEuzIjOLtGKi2Q81HYQ3TXPa61KJzu0uEbUqtCVnCEXATcUvS77by1' > sha512.hash
```

после этого используем словарь /opt/SecLists/Passwords/Common-Credentials/10k-most-common.txt

```
john --wordlist=/opt/SecLists/Passwords/Common-Credentials/10k-most-common.txt sha512.hash
```

или полный словарь

```
john --wordlist=/opt/SecLists/Passwords/xato-net-10-million-passwords-100000.txt  sha512.hash
```
